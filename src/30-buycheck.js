...
function checksFor(profile, insp) {
  ...
  for (const c of BUY_CHECKS) {
    ...
    if (!r) continue;
    out.push(r.bedingung ? Object.assign({}, c, { bedingung: r.bedingung }) : c);
  }
  return out;
}
...
const BUY_CHECKS = [
  ...
  },
  {
    ...
    good: 'Beim Benziner 06K, beim Diesel 04L. Risikoarm sind unter anderem 1.8 TFSI CJEB, 2.0 TFSI CNCD, die 2.0 TDI CSUA und CSUB sowie die späteren EA288-Varianten.',
    bad: 'Die Kombination 06J mit CDNB, CDNC, CAEA oder CAEB — verbaut vor allem in A4 B8, A5 8T und Q5 8R. Dieser Motor hat Ölverbrauch und Steuerkette in einem, die Kolbeninstandsetzung liegt bei etwa 3.000 EUR frei und 5.000 bis 6.000 EUR beim Vertragshändler.',
    severity: 'hinweis',
